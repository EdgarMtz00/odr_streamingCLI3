    ...
    <v-card>
      ...
      <v-card-text>
        <v-layout row wrap >
          ...
          <v-flex xs12>
            <v-btn color="success" block @click="saveHolder">CREATE SAGA</v-btn>
          </v-flex>
        </v-layout>
      </v-card-text>
    </v-card>
...
export default {
  data () {
    return {
      ...
      newSaga: {
        title: 'Titulo Vacio',
        coverPic: 'https://homuapp.000webhostapp.com/Imagenes/24-11-2018-14-52-57.jpg',
        bgPic: 'https://homuapp.000webhostapp.com/Imagenes/15-1-2019-2-20-45.jpg'
      }
    }
  },
  methods: {
    ...
    saveHolder () {
        ...
        this.axios.post(urlBase + 'connections/streamingContent/creating/createSaga.php', bodyFormData).then(response => {
            alert('La saga se ha creado')
