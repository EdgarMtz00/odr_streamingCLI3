...
export default {
    ...
    methods: {
        ...
        loadUploadingInfo () {
            ...
            // Getting sagas
            this.axios.get(urlBase + 'connections/getSaga.php').then(response => {
            ...
            // Getting genres
            this.axios.get(urlBase + 'connections/getGenres.php').then(response => {
                response.data.forEach(element => {
        ...
        getHolders (idSaga) {
          ...
          this.axios.post(urlBase + 'connections/getHolders.php', bodyFormData).then(response => {
        ...
        uploadContent () {
            ...
            this.axios.post(urlBase + 'connections/saveScans.php', bodyFormData).then(response => {
